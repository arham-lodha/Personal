...
Place your images in the `public/` directory (e.g., `public/images/diagram-photo.jpg`). You can then reference them directly via their absolute path from the root:

```markdown
![Description of image](/images/diagram-photo.jpg)
```
...
```html
<img src="/images/diagram-photo.jpg" alt="Description" style={{ width: '100%', border: '2px solid black' }} />
```
